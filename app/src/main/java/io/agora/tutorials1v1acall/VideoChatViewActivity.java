...
public class VideoChatViewActivity extends AppCompatActivity {
    ...
    private final RtcStateHandlerListener mRtcEventHandler = new RtcStateHandlerListener() {
        @Override
        ...
        public void startSuccess() {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(VideoChatViewActivity.this, "开始视频", Toast.LENGTH_LONG).show();
                }
            });
        }
...
//            HWCommunication.getInstance().joinChannel(channelId);
    ...
    private void initAgoraEngineAndJoinChannel() {
        ...
        if (!TextUtils.isEmpty(scoketNewMessageID)){
            HWCommunication.getInstance().joinChannel(scoketNewMessageID,mRtcEventHandler);
        }else {
            HWCommunication.getInstance().appalyVoice( mToPhone, ApplyType.APPLY_VIDEO, mRtcEventHandler);
        }
...
//        mRtcEngine = null;
    ...
    public void onLocalVideoMuteClicked(View view) {
        ...
        HWCommunication.getInstance().muteLocalVideoStream(iv.isSelected());
    ...
    public void onSwitchCameraClicked(View view) {
        HWCommunication.getInstance().switchCamera();
    }
...
//            mRtcEngine = RtcEngine.create(getBaseContext(), getString(R.string.agora_app_id), mRtcEventHandler);
    ...
    private void setupRemoteVideo(int uid) {
        ...
        SurfaceView surfaceView = HWCommunication.CreateRendererView(getBaseContext());
        container.addView(surfaceView);
        HWCommunication.getInstance().setupRemoteVideo(new VideoCanvas(surfaceView, VideoCanvas.RENDER_MODE_FIT, uid));
